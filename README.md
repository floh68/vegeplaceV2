...
- Nom: HOUTMANN
- Prénom: Florian
- URL du site: virtuosoV2.fhoutmann.fr
- Url de la maquette : https://www.figma.com/file/jYkQKBAmFF7NHgeSY4RjdH/SAE-105-(2022)-Florian_HOUTMANN?type=design&node-id=1228%3A1444&t=BEHUeBkgW0WHhrR6-1
...
- [x] Donnez l'adresse IP de votre VPS : 45.155.171.236

- [x] Donnez le login et le mot de passe admin du compte pocketbase : guest@gmail.com mdp: 0123456789

- [x] Donnez l'URL du backend `http://.../_/` (IP ou dommaine) : http://45.155.171.236/_/

- [x] Donnez l'URL du frontend `http://.../` (IP ou domaine) : http://45.155.171.236/ 

- [x] Donnez l'URL HTTP**S** du frontend `https://foo.bar/` (nom de dommaine) : https://www.virtuosov2.fhoutmann.fr